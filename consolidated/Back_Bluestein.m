...
function [gout,pixelout] = Back_Bluestein(gin,mxin,myin,pixelin,d,xstart,xend,ystart,yend,mxout,myout)
...
gout=gout./sqrt((sum(abs(gout.^2),'all'))).*sqrt((sum(abs(gin.^2),'all')));
